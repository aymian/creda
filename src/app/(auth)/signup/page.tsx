        ...
        try {
            ...
            if (!userDoc.exists()) {
                ...
                await setDoc(doc(db, "users", user.uid), {
                    uid: user.uid,
                    username: user.displayName || user.email?.split("@")[0] || "Visionary",
                    email: user.email,
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <span className="text-[13px] font-black text-black">
                                        {isLoading ? "Synchronizing..." : "Signup with Google"}
                                    </span>
                                </div>
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <span className="text-[13px] font-black text-white">Signup with X</span>
                                </div>
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <span className="text-[13px] font-black text-white font-sans">Signup with Spotify</span>
                                </div>
