                ...
                <div className="p-8 md:p-16 flex flex-col justify-center items-center">
                    <div className="w-full max-w-xs space-y-10">
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <span className="text-[13px] font-black text-black">Login with Google</span>
                                </div>
                        ...
                        <p className="mt-10 text-center text-[10px] font-bold text-white/20 uppercase tracking-widest">
                            New to the ecosystem? <Link href="/signup" className="text-white hover:text-cyber-pink transition-colors underline underline-offset-4 decoration-cyber-pink/30">Initiate Registration</Link>
                        </p>
                    </div>
                </div>
            </motion.div>
